...
const ACTIVATION_EVENT_FIXTURE: &[u8] =
    include_bytes!("../../contracts/dynamic-memory/v2/successor-activation/activation-event.jsonl");
const POSITIVE_VECTORS_FIXTURE: &[u8] =
    include_bytes!("../../contracts/dynamic-memory/v2/successor-activation/positive-vectors.jsonl");
const NEGATIVE_VECTORS_FIXTURE: &[u8] =
    include_bytes!("../../contracts/dynamic-memory/v2/successor-activation/negative-vectors.jsonl");
...
const TEST_RESULT_DIGEST: &str = "e6783b2a018957a5861fe4e0670f55613d1ace35e381a6a9f5190ea9d7fbff8d";
const STATEMENT_ID: &str = "b0f171117b3c734a2ac105d9d114c9735e57d5c0b3c6e205143826c8164e044d";
const ALICE_APPROVAL_ID: &str = "895939a2df916e78831d6e01d829380b85cb42df899698eba4a66128ee620223";
const BOB_APPROVAL_ID: &str = "b7677600be37413a5a20c305b418daf6ce997e1582207105cdbc8b1e8d4abde8";
const ACTIVATION_ID: &str = "60fe4eb627dab5e7798a22188218c308063de7eca121ea7f4b267f9ab23db4bb";
const ACCEPTED_EVENT_ID: &str = "d7f1609afb1e7ec83767dc39fefb6ad0fc491f8c3d6793e7410bd599dbb24470";
...
fn real_target() -> SemanticallyClosedStage4Package {
    ...
    .unwrap();
    let successor = SemanticallyClosedSuccessorPackage::from_manifest_verified(verified).unwrap();
...
fn statement() -> SuccessorRegistryActivationStatementV1 {
    SuccessorRegistryActivationStatementV1 {
        ...
        genesis_successor_key_bridge_digest: GenesisSuccessorKeyBridgeDigest::from_digest(digest(
            7,
        )),
        from_generation: 0,
        to_generation: 1,
...
fn statement_closes_full_predecessor_target_bridge_and_generation() {
    ...
    same_package.target_package_digest = same_package.expected_predecessor_head.head.package_digest;
...
fn approval_set_is_principal_sorted_and_statement_exact() {
    ...
    duplicate.approvals[1].signer_principal_id = duplicate.approvals[0].signer_principal_id.clone();
